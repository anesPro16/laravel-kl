        ...
        <x-slot:sidebar drawer="main-drawer" collapsible class="bg-base-100 lg:bg-inherit">
            ...
            <x-menu activate-by-route>
                ...
                <x-menu-sub title="Penjualan" icon="s-building-storefront">
                    ...
                    <x-menu-item title="Daftar Penjualan" icon="c-presentation-chart-line" link="/sale-list" />
                    <x-menu-item title="Daftar Pengembalian" icon="c-folder-open" link="/retur-list" />
                    {{-- <x-menu-item title="Daftar Penolakan" icon="o-x-mark" link="/reject-list" /> --}}
                </x-menu-sub>
                {{--Persedian,dashboard Pembelian Faktur doang --}}
                <x-menu-sub title="Pembelian" icon="m-gift">
                    <x-menu-item title="Pembelian Faktur" icon="m-gift-top" link="/faktur" />
                ...
                <x-menu-sub title="Master Data" icon="s-circle-stack">
                    ...
                    <x-menu-item title="Data Rak" icon="c-folder-open" link="/rak" />
                </x-menu-sub>
                @auth
                    <x-menu-item title="Logout" icon="o-power" wire-navigate link="/logout" />
                @endauth
                @guest
